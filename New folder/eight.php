...
<head>
  <title>VESIT Login Eighth Page</title>
      ...
      <div class="user_card">
        ...
        <div class="d-flex justify-content-center form_container">
          <form>
             ...
             <button type="button" name="button" class="btn login_btn">Name</button>
             <input type="text" name="Name" class="form-control input_user" value="" placeholder="Enter Company Name">
           </div>    
                    <div class="d-flex justify-content-center mt-3 login_container">
                        <button type="button" name="button" class="btn login_btn">Date</button>
                        <input type="text" name="Date" class="form-control input_user" value="" placeholder="dd-mm-yyyy">
                    </div>
                    <div class="d-flex justify-content-center mt-3 login_container">
                        <button type="button" name="button" class="btn login_btn">Status</button>
                        <select name="Status" id="Status" class="form-control input_user">      
                    ...
                    <div class="d-flex justify-content-center mt-3 login_container">
                        <button type="button" name="button" class="btn login_btn">Count</button>
                        <input type="text" name="Count" class="form-control input_user" value="" placeholder="Count of Students">
                    </div>
                    <div class="d-flex justify-content-center mt-3 login_container">
                        <button type="button" name="button" class="btn login_btn">Applied</button>
                        <input type="text" name="Applied" class="form-control input_user" value="" placeholder="Number of Students Applied">
                    </div>
                    <div class="d-flex justify-content-center mt-3 login_container">
                        <button type="button" name="button" class="btn login_btn"><a href="ninethpage.html">Submit</a></button>
                    </div>
                </div>
          </form>
        </div>
