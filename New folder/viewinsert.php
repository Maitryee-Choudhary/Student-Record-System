            ...
            <div id="navbarCollapse" class="collapse navbar-collapse justify-content-start">
                ...
                <div class="navbar-nav ml-auto">
                    ...
                    <ul id="menu" >
                        ...
                        <a href="index.php" class = "tab">Statistics </a> 
                        <a href="viewinsert.php" class = "tab">Records </a>  
                        <a class = "tab">Contact </a> 
                      <a href="loginpage.php" class = "tab">Logout</p>
                      </ul>
                </div>    
            </div>
        </nav>
      ...
      <div class="user_card">
        ...
        <div class="d-flex justify-content-center form_container">
          <form>
             ...
             <a href="displaystudentdetails.php"><button type="button" name="button" class="btn login_btn">View</a>
           
             </button>
           </div>    
                    <div class="d-flex justify-content-center mt-3 login_container">
                    <a href="displaystudentdetails.php"><button type="button" name="button" class="btn login_btn">Edit</a></button>
                    </div>
                    <div class="d-flex justify-content-center mt-3 login_container">
                    <a href="Student_details.php"><button type="button" name="button" class="btn login_btn">Insert New</a></button>
                    </div>
                    <div class="d-flex justify-content-center mt-3 login_container">
              <a href="9.php"><button type="button" name="button" class="btn login_btn">Report</button></a>
                    </div>
                </div>
          </form>
        </div>
